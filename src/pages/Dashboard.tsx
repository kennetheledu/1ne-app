...
export function Dashboard() {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card><CardHeader title="This month" subtitle={`${wallet.currentMonthKey} · redemption progress`} /><CapProgress used={wallet.monthlyRedeemed} cap={wallet.monthlyCap} /></Card>
